-- Create function to delete a book and all related data
...
BEGIN
  ...
  -- Delete conversation questions
  DELETE FROM public.conversation_questions WHERE book_id = target_book_id;
  GET DIAGNOSTICS temp_count = ROW_COUNT;
