...
ALTER TABLE public.chapters DROP CONSTRAINT IF EXISTS chapters_user_id_fkey;
ALTER TABLE public.chat_histories DROP CONSTRAINT IF EXISTS chat_histories_user_id_fkey;
ALTER TABLE public.orders DROP CONSTRAINT IF EXISTS orders_user_id_fkey;
ALTER TABLE public.book_profiles DROP CONSTRAINT IF EXISTS book_profiles_user_id_fkey;
...
-- Clean up orphaned data - delete records that don't have corresponding users
