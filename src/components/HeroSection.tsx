...
const HeroSection = () => {
  ...
  return <section className="relative min-h-screen flex items-center justify-center bg-gradient-subtle overflow-hidden">
      {/* Background image with overlay */}
      <div className="absolute inset-0">
        <img src={heroImage} alt="Warm multi-generational family portrait" className="w-full h-full object-cover opacity-20 max-w-full" loading="lazy" />
      ...
      <div className="relative z-10 container mx-auto px-6 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-base sm:text-xl md:text-2xl text-primary-foreground/90 mb-6 sm:mb-8 mt-4 leading-relaxed max-w-3xl mx-auto px-4 sm:px-0">
            <span className="hidden sm:inline">Share your memories through conversation, and watch as your unique life story transforms into a beautifully crafted autobiography, professionally printed and delivered to your door.</span>
