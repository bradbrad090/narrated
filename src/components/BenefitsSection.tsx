...
const BenefitsSection = () => {
  ...
  return <section className="py-12 sm:py-24 bg-gradient-subtle">
      <div className="container mx-auto px-6">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
            {benefits.map((benefit, index) => <div key={index} className="bg-card rounded-xl p-6 sm:p-8 shadow-card hover:shadow-elegant transition-elegant border border-border/50">
                <h3 className="text-xl sm:text-2xl font-semibold text-foreground mb-3 sm:mb-4">
                  {benefit.title}
                </h3>
                
                <p className="text-sm sm:text-base text-muted-foreground leading-relaxed text-center my-0">
                  {benefit.description}
                </p>
              </div>)}
          </div>
